...
quests_dir = os.path.join(base_path, 'config', 'ExpansionMod', 'Quests', 'Quests')
objectives_dir = os.path.join(base_path, 'config', 'ExpansionMod', 'Quests', 'Objectives')
npcs_dir = os.path.join(base_path, 'config', 'ExpansionMod', 'Quests', 'NPCs')
...
output_path = os.path.join(output_dir, 'quest_report.txt')
