...
xml_path = os.path.join(REPO_ROOT, 'mpmissions', 'Expansion.chernarusplus', 'db', 'mmg', 'mmg_types_atacs.xml')
json_output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'output', 'MMG_ATACS_Market.json')
